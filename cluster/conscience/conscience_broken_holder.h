 ...
 * @return
 */
struct broken_holder_s *conscience_create_broken_holder(struct conscience_s
	*conscience);
 ...
 * @return 
 */
gchar *broken_holder_write_content(struct broken_meta2_s *m2,
 ...
 * @param element
 */
void broken_holder_fix_element(struct broken_holder_s *bh,
	const gchar * element);
 ...
 * @return
 */
gboolean broken_holder_check_element_format(struct broken_holder_s *bh,
	const gchar * element);
