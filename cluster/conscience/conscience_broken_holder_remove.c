...
void
broken_holder_remove_meta2(struct broken_holder_s *bh,
...
void
broken_holder_remove_meta1(struct broken_holder_s *bh,
	struct broken_fields_s *bf)
{
	char key[STRLEN_CONTAINERID + LIMIT_LENGTH_CONTENTPATH + 1];
...
void
broken_holder_remove_content(struct broken_holder_s *bh,
	struct broken_fields_s *bf)
{
	GHashTableIter iter;
...
void
broken_holder_remove_container(struct broken_holder_s *bh,
	struct broken_fields_s *bf)
{
	GHashTableIter iter;
	gpointer k = NULL, v = NULL;
