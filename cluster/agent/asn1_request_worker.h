...
void asn1_worker_set_handlers(worker_t * asn1_worker, worker_func_f response,
	worker_func_f error, worker_func_f final);

void asn1_worker_set_session_data(worker_t * asn1_worker, void *data,
	GDestroyNotify clean);

void asn1_worker_set_request_header(worker_t * asn1_worker, const char *key,
	const char *value);

void asn1_worker_set_request_body(worker_t * asn1_worker, GByteArray * body);

void asn1_worker_set_request_body_from_buffer(worker_t * asn1_worker,
	guint8 * body, gsize body_size);
