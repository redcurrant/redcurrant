 ...
 * @return 
 */
GByteArray *gridcluster_encode_event(gridcluster_event_t * event,
	GError ** err);
 ...
 * @return 
 */
gridcluster_event_t *gridcluster_decode_event(GByteArray * encoded,
	GError ** err);
 ...
 * @return 
 */
gridcluster_event_t *gridcluster_decode_event2(const guint8 * const encoded,
	gsize encoded_size, GError ** err);
 ...
 * @param value_size
 */
void gridcluster_event_add_string(gridcluster_event_t * event,
 ...
 * @param value_size
 */
void gridcluster_event_add_buffer(gridcluster_event_t * event,
	const gchar * key, const guint8 * value, gsize value_size);
 ...
 * @return
 */
gsize gridcluster_event_get_type(gridcluster_event_t * event, gchar * dst_type,
	gsize dst_size);
 ...
 * @param str_type
 */
void gridcluster_event_set_type(gridcluster_event_t * event,
 ...
 * @param seq
 */
GError *gridcluster_event_SaveNewEvent(struct event_config_s *evt_config,
	gridcluster_event_t * evt);
 ...
 * return value
 */
gchar *gridcluster_event_get_string(gridcluster_event_t * event,
	const gchar * key);
...
int gridcluster_eventxattr_get_container_id(const gchar * path,
	container_id_t * id, gchar * str, gsize str_len);
