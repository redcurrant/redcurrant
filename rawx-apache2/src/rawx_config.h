 ...
 *
 */
apr_status_t server_init_master_stat(dav_rawx_server_conf * conf,
 ...
 *
 */
apr_status_t server_init_child_stat(dav_rawx_server_conf * conf,
	apr_pool_t * pool, apr_pool_t * plog);
 ...
 *
 */
apr_status_t server_child_stat_fini(dav_rawx_server_conf * conf,
	apr_pool_t * plog);
 ...
 *
 */
void server_add_stat(dav_rawx_server_conf * conf, const char *n,
	apr_uint32_t value, apr_uint32_t duration);
 ...
 *
 */
void server_inc_stat(dav_rawx_server_conf * conf, const char *n,
	apr_time_t duration);
 ...
 *
 */
void server_inc_request_stat(dav_rawx_server_conf * conf, const char *n,
	apr_time_t duration);
 ...
 *
 */
dav_error *server_create_and_stat_error(dav_rawx_server_conf * conf,
 ...
 *
 */
gboolean update_rawx_conf(apr_pool_t * p, rawx_conf_t ** rawx_conf,
	const gchar * ns_name);
