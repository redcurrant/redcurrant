 ...
 *
 */
struct rawx_stats_rrd_s *rawx_stats_rrd_create(apr_pool_t * pool,
	time_t period);
 ...
 *
 */
struct rawx_stats_rrd_s *rawx_stats_rrd_dup(apr_pool_t * pool,
	struct rawx_stats_rrd_s *rrd);
 ...
 *
 */
apr_uint32_t rawx_stats_rrd_get_delta(struct rawx_stats_rrd_s *rsr,
	time_t period);
 ...
 *
 */
struct delta_debug_s *rawx_stats_rrd_debug_get_delta(struct rawx_stats_rrd_s
