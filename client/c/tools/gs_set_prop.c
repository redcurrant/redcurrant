...
{
	g_printerr
		("usage: gs_set_prop [OPTIONS...]| [<NS>/<CONTAINER>/[<CONTENT>] <PROPERTY> <VALUE>]\n");
	g_printerr("Description:\n");
	g_printerr("\tGridStorage Set Property utility\n");
	g_printerr("\tSet a container or content property.\n");
	g_printerr
		("\tIf an error occurs when setting this property, gs_set_prop\n");
	...
	g_printerr
		("\t -c <TOKEN> : the name of the content. (If not specified, it search container properties)\n");
