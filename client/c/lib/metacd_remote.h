...
const gchar *make_metacd_path(const gchar * content_path,
	const gchar * content_version);
const gchar *make_metacd_path2(const gchar * content_path,
...
gboolean metacd_remote_set_meta1_master(const struct metacd_connection_info_s
	*mi, const container_id_t cid, const char *master, GError ** e);
...
struct meta2_raw_content_s *metacd_remote_get_content(const struct
	metacd_connection_info_s *mi, const container_id_t cID,
...
gboolean metacd_remote_save_content(struct metacd_connection_info_s *mi,
