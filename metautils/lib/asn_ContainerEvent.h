...
gboolean container_event_ASN2API(const ContainerEvent_t * asn,
	container_event_t * api);
gboolean container_event_API2ASN(const container_event_t * api,
	ContainerEvent_t * asn);
