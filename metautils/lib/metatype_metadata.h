 ...
 * @return
 */
GHashTable *metadata_unpack_buffer(const guint8 * data, gsize size,
	GError ** error);
 ...
 * @return
 */
GHashTable *metadata_remove_prefixed(GHashTable * unpacked,
 ...
 * @return
 */
GHashTable *metadata_extract_prefixed(GHashTable * unpacked,
	const gchar * prefix, GError ** error);
