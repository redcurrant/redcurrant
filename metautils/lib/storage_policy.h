 ...
 * @return
 */
const struct data_security_s *storage_policy_get_data_security(const struct
	storage_policy_s *sp);
 ...
 * @return
 */
const struct data_treatments_s *storage_policy_get_data_treatments(const struct
	storage_policy_s *sp);
 ...
 * @return
 */
const struct storage_class_s *storage_policy_get_storage_class(const struct
	storage_policy_s *sp);
 ...
 * @return
 */
enum data_treatments_e data_treatments_get_type(const struct data_treatments_s
	*ds);
 ...
 *
 */
GError *storage_policy_from_metadata(GByteArray * sys_metadata,
