 ...
 */
void chunk_info_print_all(const gchar * domain, const gchar * header,
	GSList * list);
 ...
 */
gint container_event_to_string(container_event_t * src, gchar * dst,
	gsize dstsize);
 ...
 */
int chunk_is_last(struct chunk_textinfo_s *chunk,
 ...
 */
gboolean convert_chunk_text_to_raw(const struct chunk_textinfo_s *text_chunk,
	struct meta2_raw_chunk_s *raw_chunk, GError ** error);
 ...
 * @return TRUE or FALSE if an error occured (error is set)
 */
gboolean convert_chunk_raw_to_text(const struct meta2_raw_content_s
	*raw_content, struct chunk_textinfo_s *text_chunk, GError ** error);
 ...
 * @return TRUE or FALSE if an error occured (error is set)
 */
gboolean convert_content_text_to_raw(const struct content_textinfo_s
	*text_content, struct meta2_raw_content_s *raw_content, GError ** error);
 ...
 * @return TRUE or FALSE if an error occured (error is set)
 */
gboolean convert_content_raw_to_text(const struct meta2_raw_content_s
	*raw_content, struct content_textinfo_s *text_content, GError ** error);
 ...
 * @deprecated
 */
struct meta2_raw_content_s *meta2_maintenance_create_content(const
	container_id_t container_id, gint64 size, guint32 nb_chunks, guint32 flags,
 ...
 * @deprecated
 */
void meta2_maintenance_increment_chunks_count(struct meta2_raw_content_s
	*content);
 ...
 * @return
 */
gint meta2_raw_chunk_cmp(const meta2_raw_chunk_t * r1,
	const meta2_raw_chunk_t * r2);
 ...
 * @return
 */
struct meta2_raw_chunk_s *meta2_maintenance_create_chunk(const chunk_id_t *
	chunk_id, const chunk_hash_t hash, guint32 flags, gint64 size,
	guint32 position);
 ...
 * @return
 */
gint meta2_property_cmp(const meta2_property_t * p1,
	const meta2_property_t * p2);
 ...
 * @return
 */
gint meta2_raw_content_header_cmp(const meta2_raw_content_header_t * r1,
 ...
 * @return
 */
gchar *meta2_raw_content_header_to_string(const meta2_raw_content_header_t *
	header);
