...
gboolean namespace_info_ASN2API(const NamespaceInfo_t * asn,
	namespace_info_t * api);
gboolean namespace_info_API2ASN(const namespace_info_t * api, gint64 version,
	NamespaceInfo_t * asn);
