...
struct meta2_ctx_s *get_meta2_ctx(const gchar * ns_name,
	const gchar * container_hexid, const gchar * content_name,
 ...
 */
void check_option_set_int(GHashTable * options, const gchar * oname,
	gint ovalue);
