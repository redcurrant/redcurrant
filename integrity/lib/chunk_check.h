 ...
 */
gboolean check_chunk_integrity(const char *chunk_path,
	const struct chunk_textinfo_s * chunk, GSList ** broken, GError ** error);
 ...
 */
gboolean check_chunk_referencing(const struct content_textinfo_s
 ...
 */
gboolean check_chunk_orphan(check_info_t * check_info, check_result_t * cres,
	GError ** p_err);
