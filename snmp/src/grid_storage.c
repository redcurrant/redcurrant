...
oid_to_string(oid * name, size_t name_len, char *dst, size_t dst_size)
{
	...
	for (i = 0; i < name_len; i++) {
		...
		dst_i +=
			g_snprintf(dst + dst_i, dst_size - dst_i, ".%" G_GINT64_FORMAT,
			i64);
		if (dst_i > dst_size)
			return;
	}
...
config_parser(const char *key, char *value)
{
	...
	if (!g_ascii_strncasecmp(key, "CollectConscience",
			strlen("CollectConscience"))) {
		ns_list = g_strsplit(value, ",", 0);
		for (i = 0; ns_list[i] != NULL; i++)
			csc_ns_list = g_slist_prepend(csc_ns_list, g_strdup(ns_list[i]));
		g_strfreev(ns_list);
	}
	else if (!g_ascii_strncasecmp(key, "GridEventSpoolDir",
			strlen("GridEventSpoolDir"))) {
...
register_config(void)
{
	...
	register_app_config_handler("CollectConscience", config_parser, NULL,
		"A coma separated list of ns names");
	register_app_config_handler("GridEventSpoolDir", config_parser, NULL,
		"A path");
}
...
init_grid_storage(void)
{
	...
	struct variable4 meta2_variables[] = {
		...
		{META2_REQ_CREATE, ASN_COUNTER, RONLY, var_meta2_entry, 4, {2, 1, 3,
						2}},
		{META2_REQ_ALLGETS, ASN_COUNTER, RONLY, var_meta2_entry, 4, {2, 1, 3,
						3}},
		{META2_REQ_LIST, ASN_COUNTER, RONLY, var_meta2_entry, 4, {2, 1, 3, 4}},
		{META2_REQ_CLOSE, ASN_COUNTER, RONLY, var_meta2_entry, 4, {2, 1, 3, 5}},
		{META2_REQ_DESTROY, ASN_COUNTER, RONLY, var_meta2_entry, 4, {2, 1, 3,
						6}},
		{META2_REQ_CONTENT_RM, ASN_COUNTER, RONLY, var_meta2_entry, 4, {2, 1, 3,
						7}},
		{META2_REQ_OPEN, ASN_COUNTER, RONLY, var_meta2_entry, 4, {2, 1, 3, 8}},
		{META2_REQ_FAIL, ASN_COUNTER, RONLY, var_meta2_entry, 4, {2, 1, 3, 9}},
		{META2_REQ_CONTENT_ALLPUTS, ASN_COUNTER, RONLY, var_meta2_entry, 4, {2,
						1, 3, 10}},
		{META2_REQ_CONTENT_ADD, ASN_COUNTER, RONLY, var_meta2_entry, 4, {2, 1,
						3, 11}},
		{META2_REQ_CONTENT_APPEND, ASN_COUNTER, RONLY, var_meta2_entry, 4, {2,
						1, 3, 12}},
		{META2_REQ_CONTENT_COMMIT, ASN_COUNTER, RONLY, var_meta2_entry, 4, {2,
						1, 3, 13}},
		{META2_REQ_CHUNK_COMMIT, ASN_COUNTER, RONLY, var_meta2_entry, 4, {2, 1,
						3, 14}},
		{META2_REQ_CONTENT_GET, ASN_COUNTER, RONLY, var_meta2_entry, 4, {2, 1,
						3, 15}},
		{META2_REQ_RPLCONTENT, ASN_COUNTER, RONLY, var_meta2_entry, 4, {2, 1, 3,
						16}},
		{META2_REQ_STATCONTENT, ASN_COUNTER, RONLY, var_meta2_entry, 4, {2, 1,
						3, 17}},

		{META2_TIME_CREATE, ASN_GAUGE, RONLY, var_meta2_entry, 4, {2, 1, 4, 1}},
		{META2_TIME_ALLGETS, ASN_GAUGE, RONLY, var_meta2_entry, 4, {2, 1, 4,
						2}},
		{META2_TIME_LIST, ASN_GAUGE, RONLY, var_meta2_entry, 4, {2, 1, 4, 3}},
		{META2_TIME_CLOSE, ASN_GAUGE, RONLY, var_meta2_entry, 4, {2, 1, 4, 4}},
		{META2_TIME_DESTROY, ASN_GAUGE, RONLY, var_meta2_entry, 4, {2, 1, 4,
						5}},
		{META2_TIME_CONTENT_RM, ASN_GAUGE, RONLY, var_meta2_entry, 4, {2, 1, 4,
						6}},
		{META2_TIME_OPEN, ASN_GAUGE, RONLY, var_meta2_entry, 4, {2, 1, 4, 7}},
		{META2_TIME_CONTENT_ALLPUTS, ASN_GAUGE, RONLY, var_meta2_entry, 4, {2,
						1, 4, 8}},
		{META2_TIME_CONTENT_ADD, ASN_GAUGE, RONLY, var_meta2_entry, 4, {2, 1, 4,
						9}},
		{META2_TIME_CONTENT_APPEND, ASN_GAUGE, RONLY, var_meta2_entry, 4, {2, 1,
						4, 10}},
		{META2_TIME_CONTENT_COMMIT, ASN_GAUGE, RONLY, var_meta2_entry, 4, {2, 1,
						4, 11}},
		{META2_TIME_CHUNK_COMMIT, ASN_GAUGE, RONLY, var_meta2_entry, 4, {2, 1,
						4, 12}},
		{META2_TIME_CONTENT_GET, ASN_GAUGE, RONLY, var_meta2_entry, 4, {2, 1, 4,
						13}},
		{META2_TIME_RPLCONTENT, ASN_GAUGE, RONLY, var_meta2_entry, 4, {2, 1, 4,
						14}},
		{META2_TIME_STATCONTENT, ASN_GAUGE, RONLY, var_meta2_entry, 4, {2, 1, 4,
						15}},
		...
		{META2_REQ_RAW_GETCONTENT, ASN_COUNTER, RONLY, var_meta2_entry, 4, {2,
						1, 8, 1}},
		{META2_REQ_RAW_GETCHUNK, ASN_COUNTER, RONLY, var_meta2_entry, 4, {2, 1,
						8, 2}},
		{META2_REQ_RAW_SETCONTENT, ASN_COUNTER, RONLY, var_meta2_entry, 4, {2,
						1, 8, 3}},
		{META2_REQ_RAW_SETCHUNK, ASN_COUNTER, RONLY, var_meta2_entry, 4, {2, 1,
						8, 4}},
		{META2_REQ_RAW_DELCONTENT, ASN_COUNTER, RONLY, var_meta2_entry, 4, {2,
						1, 8, 5}},
		{META2_REQ_RAW_DELCHUNK, ASN_COUNTER, RONLY, var_meta2_entry, 4, {2, 1,
						8, 6}},
		{META2_REQ_RAW_OTHER, ASN_COUNTER, RONLY, var_meta2_entry, 4, {2, 1, 8,
						7}},

		{META2_TIME_RAW_GETCONTENT, ASN_GAUGE, RONLY, var_meta2_entry, 4, {2, 1,
						9, 1}},
		{META2_TIME_RAW_GETCHUNK, ASN_GAUGE, RONLY, var_meta2_entry, 4, {2, 1,
						9, 2}},
		{META2_TIME_RAW_SETCONTENT, ASN_GAUGE, RONLY, var_meta2_entry, 4, {2, 1,
						9, 3}},
		{META2_TIME_RAW_SETCHUNK, ASN_GAUGE, RONLY, var_meta2_entry, 4, {2, 1,
						9, 4}},
		{META2_TIME_RAW_DELCONTENT, ASN_GAUGE, RONLY, var_meta2_entry, 4, {2, 1,
						9, 5}},
		{META2_TIME_RAW_DELCHUNK, ASN_GAUGE, RONLY, var_meta2_entry, 4, {2, 1,
						9, 6}},
		{META2_TIME_RAW_OTHER, ASN_GAUGE, RONLY, var_meta2_entry, 4, {2, 1, 9,
						7}},

		{META2_REQ_PROP_SET_CONTENT, ASN_COUNTER, RONLY, var_meta2_entry, 4, {2,
						1, 10, 1}},
		{META2_REQ_PROP_SET_CONTAINER, ASN_COUNTER, RONLY, var_meta2_entry, 4,
				{2, 1, 10, 2}},
		{META2_REQ_PROP_GET_CONTENT, ASN_COUNTER, RONLY, var_meta2_entry, 4, {2,
						1, 10, 3}},
		{META2_REQ_PROP_GET_CONTAINER, ASN_COUNTER, RONLY, var_meta2_entry, 4,
				{2, 1, 10, 4}},
		{META2_REQ_PROP_RM_CONTENT, ASN_COUNTER, RONLY, var_meta2_entry, 4, {2,
						1, 10, 5}},
		{META2_REQ_PROP_RM_CONTAINER, ASN_COUNTER, RONLY, var_meta2_entry, 4,
				{2, 1, 10, 6}},
		{META2_REQ_PROP_RPL_SET_CONTAINER, ASN_COUNTER, RONLY, var_meta2_entry,
				4, {2, 1, 10, 7}},
		{META2_REQ_PROP_RPL_RM_CONTAINER, ASN_COUNTER, RONLY, var_meta2_entry,
				4, {2, 1, 10, 8}},

		{META2_TIME_PROP_SET_CONTENT, ASN_GAUGE, RONLY, var_meta2_entry, 4, {2,
						1, 11, 1}},
		{META2_TIME_PROP_SET_CONTAINER, ASN_GAUGE, RONLY, var_meta2_entry, 4,
				{2, 1, 11, 2}},
		{META2_TIME_PROP_GET_CONTENT, ASN_GAUGE, RONLY, var_meta2_entry, 4, {2,
						1, 11, 3}},
		{META2_TIME_PROP_GET_CONTAINER, ASN_GAUGE, RONLY, var_meta2_entry, 4,
				{2, 1, 11, 4}},
		{META2_TIME_PROP_RM_CONTENT, ASN_GAUGE, RONLY, var_meta2_entry, 4, {2,
						1, 11, 5}},
		{META2_TIME_PROP_RM_CONTAINER, ASN_GAUGE, RONLY, var_meta2_entry, 4, {2,
						1, 11, 6}},
		{META2_TIME_PROP_RPL_SET_CONTAINER, ASN_GAUGE, RONLY, var_meta2_entry,
				4, {2, 1, 11, 7}},
		{META2_TIME_PROP_RPL_RM_CONTAINER, ASN_GAUGE, RONLY, var_meta2_entry, 4,
				{2, 1, 11, 8}}
	};
	...
	struct variable4 rawx_variables[] = {
		...
		{RAWX_REPLY_OTHER, ASN_COUNTER, RONLY, var_rawx_entry, 4, {2, 1, 7,
						14}},
	...
	struct variable4 saver_variables[] = {
		...
		{SAVER_REQ_STATUS, ASN_COUNTER, RONLY, var_saver_entry, 4, {2, 1, 5,
						2}},
		{SAVER_WORKERS_BYTES, ASN_COUNTER, RONLY, var_saver_entry, 4, {2, 1, 5,
						3}},
		{SAVER_WORKERS_OK, ASN_COUNTER, RONLY, var_saver_entry, 4, {2, 1, 5,
						4}},
		{SAVER_WORKERS_FAILED, ASN_COUNTER, RONLY, var_saver_entry, 4, {2, 1, 5,
						5}}
	};
	...
	struct variable4 rplx_variables[] = {
		...
		{RPLX_WORKER_QUEUE, ASN_COUNTER, RONLY, var_rplx_entry, 4, {2, 1, 6,
						4}},
	...
	REGISTER_MIB("grid/conscience", csc_variables, variable4,
		csc_variables_oid);
}
 ...
 * only one thread XXX */
static const gchar *
get_string_tag_value(struct service_info_s *si, const gchar * n,
	const gchar * def)
{
	...
	switch (tag->type) {
		case STVT_I64:
			g_snprintf(result, sizeof(result), "%" G_GINT64_FORMAT,
				tag->value.i);
			return result;
		case STVT_REAL:
...
manage_meta2(struct service_info_s *si)
{
	...
	snprintf(index_data.desc, MAX_DESC_LENGTH, "%s|%s", si->ns_name,
		snmp_data.addr);
	...
	if (!meta2_stats) {
		...
		snmp_data.req_total =
			get_double_value(meta2_stats, META2_STAT_REQ_TOTAL,
			0.0) + get_double_value(meta2_stats, META2_STAT_REQ_TOTAL_V2, 0.0);
		snmp_data.req_create =
			get_double_value(meta2_stats, META2_STAT_REQ_CREATE,
			0.0) + get_double_value(meta2_stats, META2_STAT_REQ_CREATE_V1,
			0.0) + get_double_value(meta2_stats, META2_STAT_REQ_CREATE_V2, 0.0);
		snmp_data.req_list =
			get_double_value(meta2_stats, META2_STAT_REQ_LIST,
			0.0) + get_double_value(meta2_stats, META2_STAT_REQ_LIST_V1,
			0.0) + get_double_value(meta2_stats, META2_STAT_REQ_LIST_V2, 0.0);
		snmp_data.req_close =
			get_double_value(meta2_stats, META2_STAT_REQ_CLOSE,
			0.0) + get_double_value(meta2_stats, META2_STAT_REQ_CLOSE_V2, 0.0);
		snmp_data.req_destroy =
			get_double_value(meta2_stats, META2_STAT_REQ_DESTROY,
			0.0) + get_double_value(meta2_stats, META2_STAT_REQ_DESTROY_V1,
			0.0) + get_double_value(meta2_stats, META2_STAT_REQ_DESTROY_V2,
			0.0);
		snmp_data.req_open =
			get_double_value(meta2_stats, META2_STAT_REQ_OPEN,
			0.0) + get_double_value(meta2_stats, META2_STAT_REQ_OPEN_V2, 0.0);
		snmp_data.req_failures =
			get_double_value(meta2_stats, META2_STAT_REQ_FAIL, 0.0);
		snmp_data.req_content_retrieve =
			get_double_value(meta2_stats, META2_STAT_REQ_CONTENT_RET,
			0.0) + get_double_value(meta2_stats, META2_STAT_REQ_CONTENT_RET_V1,
			0.0) + get_double_value(meta2_stats, META2_STAT_REQ_CONTENT_RET_V2,
			0.0);
		snmp_data.req_content_remove =
			get_double_value(meta2_stats, META2_STAT_REQ_CONTENT_RM,
			0.0) + get_double_value(meta2_stats, META2_STAT_REQ_CONTENT_RM_V1,
			0.0) + get_double_value(meta2_stats, META2_STAT_REQ_CONTENT_RM_V2,
			0.0);
		snmp_data.req_content_add =
			get_double_value(meta2_stats, META2_STAT_REQ_CONTENT_ADD,
			0.0) + get_double_value(meta2_stats, META2_STAT_REQ_CONTENT_ADD_V1,
			0.0) + get_double_value(meta2_stats, META2_STAT_REQ_CONTENT_ADD_V2,
			0.0);
		snmp_data.req_content_append =
			get_double_value(meta2_stats, META2_STAT_REQ_CONTENT_APPEND,
			0.0) + get_double_value(meta2_stats,
			META2_STAT_REQ_CONTENT_APPEND_V1,
			0.0) + get_double_value(meta2_stats,
			META2_STAT_REQ_CONTENT_APPEND_V2, 0.0);
		snmp_data.req_content_commit =
			get_double_value(meta2_stats, META2_STAT_REQ_CONTENT_COMMIT,
			0.0) + get_double_value(meta2_stats,
			META2_STAT_REQ_CONTENT_COMMIT_V1, 0.0);
		snmp_data.req_chunk_commit =
			get_double_value(meta2_stats, META2_STAT_REQ_CHUNK_COMMIT,
			0.0) + get_double_value(meta2_stats, META2_STAT_REQ_CHUNK_COMMIT_V1,
			0.0);
		snmp_data.req_rplcontent =
			get_double_value(meta2_stats, META2_STAT_REQ_RPLCONTENT, 0.0);
		snmp_data.req_statcontent =
			get_double_value(meta2_stats, META2_STAT_REQ_STATCONTENT, 0.0);

		snmp_data.time_create =
			get_double_value(meta2_stats, META2_STAT_TIME_CREATE,
			0.0) + get_double_value(meta2_stats, META2_STAT_TIME_CREATE_V1,
			0.0) + get_double_value(meta2_stats, META2_STAT_TIME_CREATE_V2,
			0.0);
		snmp_data.time_content_retrieve =
			get_double_value(meta2_stats, META2_STAT_TIME_CONTENT_RET,
			0.0) + get_double_value(meta2_stats, META2_STAT_TIME_CONTENT_RET_V1,
			0.0) + get_double_value(meta2_stats, META2_STAT_TIME_CONTENT_RET_V2,
			0.0);
		snmp_data.time_list =
			get_double_value(meta2_stats, META2_STAT_TIME_LIST,
			0.0) + get_double_value(meta2_stats, META2_STAT_TIME_LIST_V1,
			0.0) + get_double_value(meta2_stats, META2_STAT_TIME_LIST_V2, 0.0);
		snmp_data.time_close =
			get_double_value(meta2_stats, META2_STAT_TIME_CLOSE,
			0.0) + get_double_value(meta2_stats, META2_STAT_TIME_CLOSE_V1, 0.0);
		snmp_data.time_destroy =
			get_double_value(meta2_stats, META2_STAT_TIME_DESTROY,
			0.0) + get_double_value(meta2_stats, META2_STAT_TIME_DESTROY_V1,
			0.0) + get_double_value(meta2_stats, META2_STAT_TIME_DESTROY_V2,
			0.0);
		snmp_data.time_content_remove =
			get_double_value(meta2_stats, META2_STAT_TIME_CONTENT_RM,
			0.0) + get_double_value(meta2_stats, META2_STAT_TIME_CONTENT_RM_V1,
			0.0) + get_double_value(meta2_stats, META2_STAT_TIME_CONTENT_RM_V2,
			0.0);
		snmp_data.time_open =
			get_double_value(meta2_stats, META2_STAT_TIME_OPEN,
			0.0) + get_double_value(meta2_stats, META2_STAT_TIME_OPEN_V1, 0.0);
		snmp_data.time_content_add =
			get_double_value(meta2_stats, META2_STAT_TIME_CONTENT_ADD,
			0.0) + get_double_value(meta2_stats, META2_STAT_TIME_CONTENT_ADD_V1,
			0.0) + get_double_value(meta2_stats, META2_STAT_TIME_CONTENT_ADD_V2,
			0.0);
		snmp_data.time_content_append =
			get_double_value(meta2_stats, META2_STAT_TIME_CONTENT_APPEND,
			0.0) + get_double_value(meta2_stats,
			META2_STAT_TIME_CONTENT_APPEND_V1,
			0.0) + get_double_value(meta2_stats,
			META2_STAT_TIME_CONTENT_APPEND_V2, 0.0);
		snmp_data.time_content_commit =
			get_double_value(meta2_stats, META2_STAT_TIME_CONTENT_CI,
			0.0) + get_double_value(meta2_stats, META2_STAT_TIME_CONTENT_CI_V1,
			0.0);
		snmp_data.time_chunk_commit =
			get_double_value(meta2_stats, META2_STAT_TIME_CHUNK_CI,
			0.0) + get_double_value(meta2_stats, META2_STAT_TIME_CHUNK_CI_V1,
			0.0);
		snmp_data.time_rplcontent =
			get_double_value(meta2_stats, META2_STAT_TIME_RPLCONTENT, 0.0);
		snmp_data.time_statcontent =
			get_double_value(meta2_stats, META2_STAT_TIME_STATCONTENT, 0.0);

		snmp_data.req_maintenance_getcontent =
			get_double_value(meta2_stats, META2_STAT_REQ_RAW_GETCONTENT, 0.0) +
			get_double_value(meta2_stats, META2_STAT_REQ_RAW_GETCONTENT_V1,
			0.0);
		snmp_data.req_maintenance_getchunks =
			get_double_value(meta2_stats, META2_STAT_REQ_RAW_GETCHUNK,
			0.0) + get_double_value(meta2_stats, META2_STAT_REQ_RAW_GETCHUNK_V1,
			0.0);
		snmp_data.req_maintenance_setcontent =
			get_double_value(meta2_stats, META2_STAT_REQ_RAW_SETCONTENT,
			0.0) + get_double_value(meta2_stats,
			META2_STAT_REQ_RAW_SETCONTENT_V1, 0.0);
		snmp_data.req_maintenance_setchunks =
			get_double_value(meta2_stats, META2_STAT_REQ_RAW_SETCHUNK,
			0.0) + get_double_value(meta2_stats, META2_STAT_REQ_RAW_SETCHUNK_V1,
			0.0);
		snmp_data.req_maintenance_delcontent =
			get_double_value(meta2_stats, META2_STAT_REQ_RAW_DELCONTENT,
			0.0) + get_double_value(meta2_stats,
			META2_STAT_REQ_RAW_DELCONTENT_V1, 0.0);
		snmp_data.req_maintenance_delchunks =
			get_double_value(meta2_stats, META2_STAT_REQ_RAW_DELCHUNK,
			0.0) + get_double_value(meta2_stats, META2_STAT_REQ_RAW_DELCHUNK_V1,
			0.0);
		snmp_data.req_maintenance_other =
			get_double_value(meta2_stats, META2_STAT_REQ_RAW_OTHER, 0.0);

		snmp_data.time_maintenance_getcontent =
			get_double_value(meta2_stats, META2_STAT_TIME_RAW_GETCONTENT, 0.0) +
			get_double_value(meta2_stats, META2_STAT_TIME_RAW_GETCONTENT_V1,
			0.0);
		snmp_data.time_maintenance_getchunks =
			get_double_value(meta2_stats, META2_STAT_TIME_RAW_GETCHUNK,
			0.0) + get_double_value(meta2_stats,
			META2_STAT_TIME_RAW_GETCHUNK_V1, 0.0);
		snmp_data.time_maintenance_setcontent =
			get_double_value(meta2_stats, META2_STAT_TIME_RAW_SETCONTENT,
			0.0) + get_double_value(meta2_stats,
			META2_STAT_TIME_RAW_SETCONTENT_V1, 0.0);
		snmp_data.time_maintenance_setchunks =
			get_double_value(meta2_stats, META2_STAT_TIME_RAW_SETCHUNK,
			0.0) + get_double_value(meta2_stats,
			META2_STAT_TIME_RAW_SETCHUNK_V1, 0.0);
		snmp_data.time_maintenance_delcontent =
			get_double_value(meta2_stats, META2_STAT_TIME_RAW_DELCONTENT,
			0.0) + get_double_value(meta2_stats,
			META2_STAT_TIME_RAW_DELCONTENT_V1, 0.0);
		snmp_data.time_maintenance_delchunks =
			get_double_value(meta2_stats, META2_STAT_TIME_RAW_DELCHUNK,
			0.0) + get_double_value(meta2_stats,
			META2_STAT_TIME_RAW_DELCHUNK_V1, 0.0);
		snmp_data.time_maintenance_other =
			get_double_value(meta2_stats, META2_STAT_TIME_RAW_OTHER, 0.0);
		...
		snmp_data.req_prop_set_container =
			get_double_value(meta2_stats, META2_STAT_REQ_PROP_SET_CONTAINER,
			0.0);
		...
		snmp_data.req_prop_get_container =
			get_double_value(meta2_stats, META2_STAT_REQ_PROP_GET_CONTAINER,
			0.0);
		...
		snmp_data.req_prop_rm_container =
			get_double_value(meta2_stats, META2_STAT_REQ_PROP_RM_CONTAINER,
			0.0);
		snmp_data.req_prop_rpl_set_container =
			get_double_value(meta2_stats, META2_STAT_REQ_PROP_RPL_SET_CONTAINER,
			0.0);
		snmp_data.req_prop_rpl_rm_container =
			get_double_value(meta2_stats, META2_STAT_REQ_PROP_RPL_RM_CONTAINER,
			0.0);

		snmp_data.time_prop_set_content =
			get_double_value(meta2_stats, META2_STAT_TIME_PROP_SET_CONTENT,
			0.0);
		snmp_data.time_prop_set_container =
			get_double_value(meta2_stats, META2_STAT_TIME_PROP_SET_CONTAINER,
			0.0);
		snmp_data.time_prop_get_content =
			get_double_value(meta2_stats, META2_STAT_TIME_PROP_GET_CONTENT,
			0.0);
		snmp_data.time_prop_get_container =
			get_double_value(meta2_stats, META2_STAT_TIME_PROP_GET_CONTAINER,
			0.0);
		...
		snmp_data.time_prop_rm_container =
			get_double_value(meta2_stats, META2_STAT_TIME_PROP_RM_CONTAINER,
			0.0);
		snmp_data.time_prop_rpl_set_container =
			get_double_value(meta2_stats,
			META2_STAT_TIME_PROP_RPL_SET_CONTAINER, 0.0);
		snmp_data.time_prop_rpl_rm_container =
			get_double_value(meta2_stats, META2_STAT_TIME_PROP_RPL_RM_CONTAINER,
			0.0);

		snmp_data.nb_thread =
			get_double_value(meta2_stats, META2_STAT_NB_THREAD,
			0.0) + get_double_value(meta2_stats, META2_STAT_NB_THREAD_V2, 0.0);
	...
	meta2_snmp_data[index_data.idx] =
		g_memdup(&snmp_data, sizeof(struct meta2_snmp_data));
...
manage_saver(struct service_info_s *si)
{
	...
	g_snprintf(index_data.desc, MAX_DESC_LENGTH, "%s|%s", snmp_data.namespace,
		snmp_data.addr);
	...
	if (!saver_stats) {
		...
		snmp_data.req_status =
			get_double_value(saver_stats, SAVER_STAT_REQ_STATUS, 0.0);
		snmp_data.req_push =
			get_double_value(saver_stats, SAVER_STAT_REQ_PUSH, 0.0);
		snmp_data.workers_bytes =
			get_double_value(saver_stats, SAVER_STAT_BYTES, 0.0);
		snmp_data.workers_ok =
			get_double_value(saver_stats, SAVER_STAT_WORKER_OK, 0.0);
		snmp_data.workers_ko =
			get_double_value(saver_stats, SAVER_STAT_WORKER_KO, 0.0);
	...
	saver_snmp_data[index_data.idx] =
		g_memdup(&snmp_data, sizeof(struct saver_snmp_data));
...
manage_rawx(struct service_info_s *si)
{
	...
	strncpy(snmp_data.namespace, si->ns_name, LIMIT_LENGTH_NSNAME);
	addr_info_to_string(&(si->addr), snmp_data.addr, sizeof(snmp_data.addr));
	strncpy(snmp_data.volume, get_string_tag_value(si, "tag.vol",
			snmp_data.addr), LIMIT_LENGTH_VOLUMENAME);
	snmp_data.score = si->score.value;
	...
	rawx_stats =
		session ? rawx_client_get_statistics(session, RAWX_STAT_URL,
		&error) : NULL;
	...
	if (!rawx_stats) {
		...
		snmp_data.req_all =
			get_double_value(rawx_stats, RAWX_STATKEY_REQ_ALL, 0.0);
		snmp_data.req_get =
			get_double_value(rawx_stats, RAWX_STATKEY_REQ_GET, 0.0);
		snmp_data.req_put =
			get_double_value(rawx_stats, RAWX_STATKEY_REQ_PUT, 0.0);
		snmp_data.req_del =
			get_double_value(rawx_stats, RAWX_STATKEY_REQ_DEL, 0.0);
		snmp_data.req_info =
			get_double_value(rawx_stats, RAWX_STATKEY_REQ_INFO, 0.0);
		snmp_data.req_stat =
			get_double_value(rawx_stats, RAWX_STATKEY_REQ_STAT, 0.0);
		snmp_data.req_raw =
			get_double_value(rawx_stats, RAWX_STATKEY_REQ_RAW, 0.0);
		snmp_data.req_other =
			get_double_value(rawx_stats, RAWX_STATKEY_REQ_OTHER, 0.0);

		snmp_data.rep_2xx =
			get_double_value(rawx_stats, RAWX_STATKEY_REP_2XX, 0.0);
		snmp_data.rep_4xx =
			get_double_value(rawx_stats, RAWX_STATKEY_REP_4XX, 0.0);
		snmp_data.rep_5xx =
			get_double_value(rawx_stats, RAWX_STATKEY_REP_5XX, 0.0);
		snmp_data.rep_403 =
			get_double_value(rawx_stats, RAWX_STATKEY_REP_403, 0.0);
		snmp_data.rep_404 =
			get_double_value(rawx_stats, RAWX_STATKEY_REP_404, 0.0);
		snmp_data.rep_other =
			get_double_value(rawx_stats, RAWX_STATKEY_REP_OTHER, 0.0);

		snmp_data.bytes_read =
			get_double_value(rawx_stats, RAWX_STATKEY_BYTES_READ, 0.0);
		snmp_data.bytes_written =
			get_double_value(rawx_stats, RAWX_STATKEY_BYTES_WRITTEN, 0.0);
	...
	rawx_snmp_data[index_data.idx] =
		g_memdup(&snmp_data, sizeof(struct rawx_snmp_data));
...
manage_tsmx(struct service_info_s *si)
{
	...
	g_strlcpy(snmp_data.namespace, si->ns_name,
		sizeof(snmp_data.namespace) - 1);
	addr_info_to_string(&(si->addr), snmp_data.addr, sizeof(snmp_data.addr));
	snmp_data.score = si->score.value;
	...
	rawx_client_session_set_timeout(session, SOCK_TIMEOUT, SOCK_TIMEOUT);
	tsmx_stats =
		session ? rawx_client_get_statistics(session, TSMX_STAT_URL,
		&error) : NULL;
	rawx_client_free_session(session);
	if (!tsmx_stats) {
		...
		snmp_data.req_put =
			get_double_value(tsmx_stats, TSMX_STATKEY_REQ_PUT, 0.0);
		snmp_data.req_get =
			get_double_value(tsmx_stats, TSMX_STATKEY_REQ_GET, 0.0);
		snmp_data.req_del =
			get_double_value(tsmx_stats, TSMX_STATKEY_REQ_DEL, 0.0);
		snmp_data.failed =
			get_double_value(tsmx_stats, TSMX_STATKEY_FAILED, 0.0);
		snmp_data.bytes_in =
			get_double_value(tsmx_stats, TSMX_STATKEY_BYTES_IN, 0.0);
		snmp_data.bytes_out =
			get_double_value(tsmx_stats, TSMX_STATKEY_BYTES_OUT, 0.0);
	...
	tsmx_snmp_data[index_data.idx] =
		g_memdup(&snmp_data, sizeof(struct tsmx_snmp_data));
...
manage_solr(struct service_info_s *si)
{
	...
	rawx_client_session_set_timeout(session, SOCK_TIMEOUT, SOCK_TIMEOUT);
	solr_stats =
		session ? rawx_client_get_statistics(session, SOLR_STAT_URL,
		&error) : NULL;
	rawx_client_free_session(session);
	if (!solr_stats) {
		...
		snmp_data.req_search =
			get_double_value(solr_stats, SOLR_STATKEY_REQ_SEARCH, 0.0);
		snmp_data.req_update =
			get_double_value(solr_stats, SOLR_STATKEY_REQ_UPDATE, 0.0);
		snmp_data.time_search =
			get_double_value(solr_stats, SOLR_STATKEY_TIME_SEARCH, 0.0);
		snmp_data.time_update =
			get_double_value(solr_stats, SOLR_STATKEY_TIME_UPDATE, 0.0);
		snmp_data.commits =
			get_double_value(solr_stats, SOLR_STATKEY_COMMITS, 0.0);
	...
	solr_snmp_data[index_data.idx] =
		g_memdup(&snmp_data, sizeof(struct solr_snmp_data));
...
manage_rplx(struct service_info_s *si)
{
	...
	if (!rplx_stats) {
		...
		snmp_data.worker_current =
			get_double_value(rplx_stats, RPLX_STAT_WORKERS_CUR, 0.0);
		snmp_data.worker_idle =
			get_double_value(rplx_stats, RPLX_STAT_WORKERS_IDLE, 0.0);
		snmp_data.worker_max =
			get_double_value(rplx_stats, RPLX_STAT_WORKERS_MAX, 0.0);
		snmp_data.worker_queue =
			get_double_value(rplx_stats, RPLX_STAT_WORKERS_QUEUE, 0.0);
		snmp_data.req_push =
			get_double_value(rplx_stats, RPLX_STAT_REQ_PUSH, 0.0);
		snmp_data.req_status =
			get_double_value(rplx_stats, RPLX_STAT_REQ_STATUS, 0.0);
		snmp_data.req_total =
			get_double_value(rplx_stats, RPLX_STAT_REQ_TOTAL, 0.0);

		snmp_data.nb_thread =
			*(gdouble *) g_hash_table_lookup(rplx_stats, RPLX_STAT_NB_THREAD);
	...
	rplx_snmp_data[index_data.idx] =
		g_memdup(&snmp_data, sizeof(struct rplx_snmp_data));
...
manage_evt(const gchar * ns_name)
{
	...
	fullpath =
		g_strconcat(evt_spool_dir, G_DIR_SEPARATOR_S, ns_name,
		G_DIR_SEPARATOR_S, "incoming", NULL);
	if (stat_events(&incoming_stat, fullpath)) {
		snmp_data.incoming_nb = incoming_stat.nb_evt;
		if (incoming_stat.nb_evt > 0) {
			snmp_data.incoming_age =
				incoming_stat.total_age / incoming_stat.nb_evt;
	...
	evt_snmp_data[index_data.idx] =
		g_memdup(&snmp_data, sizeof(struct evt_snmp_data));
...
manage_csc(const gchar * ns_name)
{
	...
	if (!get_idx_of_service("csc", &index_data, &error)) {
		DEBUGMSGTL(("grid",
				"Failed to retrieve index of conscience [%s] : %s\n",
				index_data.desc, error->message));
		g_clear_error(&error);
		return;
	}
	...
	if (!csc_stats) {
		...
		snmp_data.nb_thread =
			*(gdouble *) g_hash_table_lookup(csc_stats, CSC_STAT_NB_THREAD);
		g_hash_table_destroy(csc_stats);
	}

	/* Get service stats */
	services =
		gcluster_get_services(&csc_addr, SOCK_TIMEOUT, NAME_SRVTYPE_RAWX,
		&error);
	if (services == NULL) {
		DEBUGMSGTL(("grid",
				"Failed to retrieve the list of RAWX in namespace [%s] : %s\n",
				ns_name, error->message));
		g_clear_error(&error);
	}
	...
	csc_snmp_data[index_data.idx] =
		g_memdup(&snmp_data, sizeof(struct csc_snmp_data));
...
u_char *
var_meta2_number(struct variable * vp, oid * name, size_t * length, int exact,
	size_t * var_len, WriteMethod ** write_method)
{
	return __get_simple(__FUNCTION__, META2_NUMBER, vp, name, length, exact,
		var_len, write_method);
}

u_char *
var_rawx_number(struct variable * vp, oid * name, size_t * length, int exact,
	size_t * var_len, WriteMethod ** write_method)
{
	return __get_simple(__FUNCTION__, RAWX_NUMBER, vp, name, length, exact,
		var_len, write_method);
}

u_char *
var_saver_number(struct variable * vp, oid * name, size_t * length, int exact,
	size_t * var_len, WriteMethod ** write_method)
{
	return __get_simple(__FUNCTION__, SAVER_NUMBER, vp, name, length, exact,
		var_len, write_method);
}

u_char *
var_tsmx_number(struct variable * vp, oid * name, size_t * length, int exact,
	size_t * var_len, WriteMethod ** write_method)
{
	return __get_simple(__FUNCTION__, TSMX_NUMBER, vp, name, length, exact,
		var_len, write_method);
}

u_char *
var_solr_number(struct variable * vp, oid * name, size_t * length, int exact,
	size_t * var_len, WriteMethod ** write_method)
{
	return __get_simple(__FUNCTION__, SOLR_NUMBER, vp, name, length, exact,
		var_len, write_method);
}

u_char *
var_rplx_number(struct variable * vp, oid * name, size_t * length, int exact,
	size_t * var_len, WriteMethod ** write_method)
{
	return __get_simple(__FUNCTION__, RPLX_NUMBER, vp, name, length, exact,
		var_len, write_method);
}

u_char *
var_evt_number(struct variable * vp, oid * name, size_t * length, int exact,
	size_t * var_len, WriteMethod ** write_method)
{
	return __get_simple(__FUNCTION__, EVT_NUMBER, vp, name, length, exact,
		var_len, write_method);
}

u_char *
var_csc_number(struct variable * vp, oid * name, size_t * length, int exact,
	size_t * var_len, WriteMethod ** write_method)
{
	return __get_simple(__FUNCTION__, CSC_NUMBER, vp, name, length, exact,
		var_len, write_method);
}
...
u_char *
var_meta2_entry(struct variable * vp, oid * name, size_t * length, int exact,
	size_t * var_len, WriteMethod ** write_method)
{
	gchar str_oid[256] = { 0, 0 };
	int idx;
	...
	switch (vp->magic) {
		...
		case META2_REQ_CONTENT_ALLPUTS:
			long_return =
				snmp_data->req_content_add + snmp_data->req_content_append;
			return (u_char *) & long_return;
		...
		case META2_TIME_CONTENT_ALLPUTS:
			long_return =
				snmp_data->time_content_add + snmp_data->time_content_append;
			return (u_char *) & long_return;
			...
			CASELONG(META2_REQ_PROP_RPL_SET_CONTAINER,
				req_prop_rpl_set_container);
			CASELONG(META2_REQ_PROP_RPL_RM_CONTAINER,
				req_prop_rpl_rm_container);
			...
			CASELONG(META2_TIME_PROP_RPL_SET_CONTAINER,
				time_prop_rpl_set_container);
			CASELONG(META2_TIME_PROP_RPL_RM_CONTAINER,
				time_prop_rpl_rm_container);
...
u_char *
var_rawx_entry(struct variable * vp, oid * name, size_t * length, int exact,
	size_t * var_len, WriteMethod ** write_method)
{
	gchar str_oid[256] = { 0, 0 };
	int idx;
...
u_char *
var_saver_entry(struct variable * vp, oid * name, size_t * length, int exact,
	size_t * var_len, WriteMethod ** write_method)
{
	gchar str_oid[256] = { 0, 0 };
	int idx;
...
u_char *
var_tsmx_entry(struct variable * vp, oid * name, size_t * length, int exact,
	size_t * var_len, WriteMethod ** write_method)
{
	gchar str_oid[256] = { 0, 0 };
	int idx;
...
u_char *
var_solr_entry(struct variable * vp, oid * name, size_t * length, int exact,
	size_t * var_len, WriteMethod ** write_method)
{
	gchar str_oid[256] = { 0, 0 };
	int idx;
...
u_char *
var_rplx_entry(struct variable * vp, oid * name, size_t * length, int exact,
	size_t * var_len, WriteMethod ** write_method)
{
	gchar str_oid[256] = { 0, 0 };
	int idx;
...
u_char *
var_evt_entry(struct variable * vp, oid * name, size_t * length, int exact,
	size_t * var_len, WriteMethod ** write_method)
{
	gchar str_oid[256] = { 0, 0 };
	int idx;
...
u_char *
var_csc_entry(struct variable * vp, oid * name, size_t * length, int exact,
	size_t * var_len, WriteMethod ** write_method)
{
	gchar str_oid[256] = { 0, 0 };
	int idx;
