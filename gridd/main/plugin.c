...
gpointer
plugin_get_api(const gchar * plugin_name, GError ** err)
{
	gpointer ptr;
	struct plugin_s *plg;
...
gint
plugin_holder_keep(GModule * mod, GHashTable * params, GError ** err)
{
...
gint
plugin_holder_close_all(GError ** err)
{
...
gint
plugin_holder_init_all(GError ** err)
{
	gboolean mayContinue = TRUE;
...
gint
plugin_holder_update_config(GModule * mod, GHashTable * params, GError ** err)
{
	struct plugin_s *plg = NULL;
...
gint
plugin_holder_reload_all(GError ** err)
{
	gboolean mayContinue = TRUE;
