...
gint format_addr(struct sockaddr *sa, gchar * h, gsize hL, gchar * p, gsize pL,
	GError ** err);

gint resolve(struct sockaddr_storage *sa, const gchar * h, const gchar * p,
	GError ** err);
 ...
 */
gint accept_add_inet(ACCEPT_POOL ap, const gchar * h, const gchar * p,
	GError ** err);
