...
typedef int (*srv_alert_handler) (void *user_data, const char *id,
	const char *criticity, const char *msg);
...
int srv_send_valert(const char *id, const char *criticity, const char *fmt,
	va_list args);
