...
typedef void (*srvstat_iterator_gvariant_f) (gpointer u, const gchar * name,
	GVariant * gv);
...
void srvstat_foreach_gvariant(const gchar * pattern,
	srvstat_iterator_gvariant_f cb, void *udata);
