 ...
 *
 */
struct rainx_stats_rrd_s *rainx_stats_rrd_create(apr_pool_t * pool,
	time_t period);
 ...
 *
 */
struct rainx_stats_rrd_s *rainx_stats_rrd_dup(apr_pool_t * pool,
	struct rainx_stats_rrd_s *rrd);
 ...
 *
 */
apr_uint64_t rainx_stats_rrd_get_delta(struct rainx_stats_rrd_s *rsr,
	time_t period);
 ...
 *
 */
struct delta_debug_s *rainx_stats_rrd_debug_get_delta(struct rainx_stats_rrd_s
	*rsr, apr_pool_t * p, time_t period);

char *rainx_stats_rrd_dump_values(struct rainx_stats_rrd_s *str,
	apr_pool_t * p);
