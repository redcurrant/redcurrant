 ...
 *
 */
apr_status_t server_init_master_stat(dav_rainx_server_conf * conf,
	apr_pool_t * pool, apr_pool_t * plog);
 ...
 *
 */
apr_status_t server_init_child_stat(dav_rainx_server_conf * conf,
	apr_pool_t * pool, apr_pool_t * plog);
 ...
 *
 */
apr_status_t server_child_stat_fini(dav_rainx_server_conf * conf,
	apr_pool_t * plog);
 ...
 *
 */
void server_add_stat(dav_rainx_server_conf * conf, const char *n,
	apr_uint64_t value, apr_uint64_t duration);
 ...
 *
 */
void server_inc_stat(dav_rainx_server_conf * conf, const char *n,
	apr_time_t duration);
 ...
 *
 */
void server_inc_request_stat(dav_rainx_server_conf * conf, const char *n,
	apr_time_t duration);
 ...
 *
 */
dav_error *server_create_and_stat_error(dav_rainx_server_conf * conf,
	apr_pool_t * p, int status, int error_id, const char *desc);
 ...
 *
 */
void server_getall_stat(dav_rainx_server_conf * conf, apr_pool_t * pool,
 ...
 *
 */
apr_int64_t _get_compression_block_size(apr_pool_t * p,
 ...
 *
 */
gboolean update_rainx_conf(apr_pool_t * p, rawx_conf_t ** rainx_conf,
	const gchar * ns_name);

/**
 * Update the rainx configuration if it's older than a fixed delay
 */
gboolean update_rainx_conf_if_necessary(apr_pool_t * p,
	rawx_conf_t ** rainx_conf);
