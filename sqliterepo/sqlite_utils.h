...
void sqlx_admin_init_i64(struct sqlx_sqlite3_s *sq3, const gchar * k,
	const gint64 v);

void sqlx_admin_set_i64(struct sqlx_sqlite3_s *sq3, const gchar * k,
	const gint64 v);

void sqlx_admin_inc_i64(struct sqlx_sqlite3_s *sq3, const gchar * k,
	const gint64 delta);

void sqlx_admin_inc_version(struct sqlx_sqlite3_s *sq3, const gchar * k,
	const int delta);

void sqlx_admin_inc_all_versions(struct sqlx_sqlite3_s *sq3, const int delta);

void sqlx_admin_set_str(struct sqlx_sqlite3_s *sq3, const gchar * k,
	const gchar * v);

void sqlx_admin_init_str(struct sqlx_sqlite3_s *sq3, const gchar * k,
	const gchar * v);

void sqlx_admin_set_gba(struct sqlx_sqlite3_s *sq3, const gchar * k,
	GByteArray * gba);

gint64 sqlx_admin_get_i64(struct sqlx_sqlite3_s *sq3, const gchar * k,
	const gint64 def);
