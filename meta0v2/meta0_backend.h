 ...
 * @return
 */
struct sqlx_repository_s *meta0_backend_get_repository(struct meta0_backend_s
	*m0);
 ...
 * @return
 */
GError *meta0_backend_get_all(struct meta0_backend_s *m0, GPtrArray ** result);
 ...
 * @return
 */
GError *meta0_backend_destroy_meta1_ref(struct meta0_backend_s *m0,
	gchar * meta1);
