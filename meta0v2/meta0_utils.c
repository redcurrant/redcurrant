...
meta0_utils_list_to_tree(GSList * list)
{
	...
	result = g_tree_new_full(hashstr_quick_cmpdata, NULL,
...
gboolean
meta0_utils_array_replace(GPtrArray * gpa, const guint8 * bytes,
...
gboolean
meta0_utils_unpack_meta1ref(const gchar * s_m1ref, gchar ** addr, gchar ** ref,
	gchar ** nb)
{
	(void) addr;
	(void) ref;
