...
gboolean
pes_get_status(const gchar * ueid, event_status_et * status)
{
	polix_event_storage_t *pes = NULL;
...
gboolean
pes_set_status(polix_event_t * pe, event_status_et status)
{
	polix_event_storage_t *pes = NULL;
...
gboolean
pes_delete(const gchar * ueid, gboolean bAll)
{
	polix_event_storage_t *pes = NULL;
