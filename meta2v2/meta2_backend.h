...
struct event_config_s *meta2_backend_get_event_config(struct meta2_backend_s
	*m2, const gchar * ns_name);
...
GError *meta2_backend_delete_alias(struct meta2_backend_s *m2b,
	struct hc_url_s *url, gboolean sync_del, m2_onbean_cb cb, gpointer u0);
 ...
 */
GError *meta2_backend_get_conditionned_spare_chunks_v2(struct meta2_backend_s
	*m2b, struct hc_url_s *url, const gchar * stgpol, GSList * notin,
 ...
 * @return
 */
GError *meta2_backend_restore_container_from_peer(struct meta2_backend_s *m2b,
	struct hc_url_s *url, const container_id_t peer_cid,
	const addr_info_t * peer_addr, gpointer notify_udata,
 ...
 */
GError *meta2_backend_get_content_urls_from_chunk_id(struct meta2_backend_s
	*m2b, struct hc_url_s *url, const gchar * chunk_id, gint64 limit,
	GSList ** urls);
