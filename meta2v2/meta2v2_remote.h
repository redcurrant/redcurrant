...
GByteArray *m2v2_remote_pack_EXITELECTION(GByteArray * sid,
	struct hc_url_s *url);
...
GByteArray *m2v2_remote_pack_SNAP_RESTORE(GByteArray * sid,
	struct hc_url_s *url, gboolean hard_restore);

GByteArray *m2v2_remote_pack_SNAP_DELETE(GByteArray * sid,
	struct hc_url_s *url);

GByteArray *m2v2_remote_pack_TOUCH_content(GByteArray * sid,
	struct hc_url_s *url);
GByteArray *m2v2_remote_pack_TOUCH_container(GByteArray * sid,
