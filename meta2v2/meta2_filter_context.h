 ...
 *
 */
void meta2_filter_ctx_set_url(struct gridd_filter_ctx_s *ctx,
	struct hc_url_s *url);

/*!
 *
 */
void meta2_filter_ctx_add_param(struct gridd_filter_ctx_s *ctx, const char *k,
	const char *v);

/*!
 *
 */
const char *meta2_filter_ctx_get_param(const struct gridd_filter_ctx_s *ctx,
	const char *name);

/*!
 *
 */
struct meta2_backend_s *meta2_filter_ctx_get_backend(const struct
	gridd_filter_ctx_s *ctx);

/*!
 *
 */
void meta2_filter_ctx_set_backend(struct gridd_filter_ctx_s *ctx,
 ...
 *
 */
void meta2_filter_ctx_set_input_udata(const struct gridd_filter_ctx_s *ctx,
