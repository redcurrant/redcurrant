...
void transient_put(GTree * t, const gchar * key, gpointer what,
	GDestroyNotify cleanup);
...
GError *m2b_transient_put(struct meta2_backend_s *m2b, const gchar * key,
	const gchar * hexid, gpointer what, GDestroyNotify cleanup);

gpointer m2b_transient_get(struct meta2_backend_s *m2b, const gchar * key,
	const gchar * hexid, GError ** err);

GError *m2b_transient_del(struct meta2_backend_s *m2b, const gchar * key,
	const gchar * hexid);
