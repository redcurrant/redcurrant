	...
	gpointer gdata, gpointer hdata)
{
	...
	if (!fl) {
		GRID_INFO
			("No filter defined for this request, consider not yet implemented");
...
meta2_gridd_get_v2_requests(void)
{
	...
	static struct gridd_request_descr_s descriptions[] = {
		...
		{"M2V2_SNAP_RESTORE", (hook) meta2_dispatch_all,
				M2V2_SNAPRESTORE_FILTERS},
		{"M2V2_SNAP_DEL", (hook) meta2_dispatch_all, M2V2_SNAPDEL_FILTERS},

		/* raw beans */
		{"M2V2_RAW_DEL", (hook) meta2_dispatch_all, M2V2_RAW_DEL},

		{"M2V2_EXITELECTION", (hook) meta2_dispatch_all,
				M2V2_EXITELECTION_FILTERS},
...
meta2_gridd_get_v1_requests(void)
{
	...
	static struct gridd_request_descr_s descriptions[] = {
		...
		{"META2_SERVICES_LIST_CONTENT_SPECIF", (hook) meta2_dispatch_all,
				M2V2_FILTERS_list_v1},

		/* CONTAINER PROPERTIES */
		{"REQ_M2RAW_ADMIN_GETALL", (hook) meta2_dispatch_all,
				M2V2_FILTERS_getall_admin_v1},
		{"REQ_M2RAW_ADMIN_SETONE", (hook) meta2_dispatch_all,
				M2V2_FILTERS_setone_admin_v1},
		{"META2_SERVICES_SET_CONTAINER_GLOBAL_PROPERTY",
				(hook) meta2_dispatch_all, M2V2_FILTERS_set_container_prop_v1},
		{"META2_SERVICES_SET_CONTAINER_PROPERTY", (hook) meta2_dispatch_all,
				M2V2_FILTERS_set_container_prop_v1},
		{"META2_SERVICES_REPLICATE_SET_CONTAINER_PROPERTY",
				(hook) meta2_dispatch_all,
				M2V2_FILTERS_replicate_container_properties},
		{"META2_SERVICES_GET_CONTAINER_PROPERTY", (hook) meta2_dispatch_all,
				M2V2_FILTERS_get_container_prop_v1},
		{"META2_SERVICES_LIST_ALL_CONTAINER_PROPERTIES",
				(hook) meta2_dispatch_all,
				M2V2_FILTERS_list_all_container_properties},
		{"META2_SERVICES_LIST_CONTAINER_PROPERTIES", (hook) meta2_dispatch_all,
				M2V2_FILTERS_list_usr_container_properties},
		{"META2_SERVICES_REMOVE_CONTAINER_PROPERTY", (hook) meta2_dispatch_all,
				M2V2_FILTERS_remove_container_property},
		{"META2_SERVICES_REPLICATE_REMOVE_CONTAINER_PROPERTY",
				(hook) meta2_dispatch_all,
				M2V2_FILTERS_replicate_remove_container_property},

		/* CONTENT LEVEL */
		{"REQ_M2_CONTENTADD", (hook) meta2_dispatch_all, M2V2_FILTERS_add_v1},
		{"REQ_M2_CHUNK_COMMIT", (hook) meta2_dispatch_all,
				M2V2_FILTERS_chunk_commit_v1},
		{"REQ_M2_CONTENTRETRIEVE", (hook) meta2_dispatch_all,
				M2V2_FILTERS_retrieve_v1},
		{"REQ_M2_CONTENTREMOVE", (hook) meta2_dispatch_all,
				M2V2_FILTERS_remove_v1},
		{"REQ_M2_CONTENTCOMMIT", (hook) meta2_dispatch_all,
				M2V2_FILTERS_content_commit_v1},
		{"REQ_M2_CONTENTSPARE", (hook) meta2_dispatch_all,
				M2V2_FILTERS_spare_v1},
		{"REQ_M2_CONTENTAPPEND", (hook) meta2_dispatch_all,
				M2V2_FILTERS_append_v1},
		{"REQ_M2_CONTENTROLLBACK", (hook) meta2_dispatch_all,
				M2V2_FILTERS_content_rollback_v1},
		{"META2_SERVICES_STAT_CONTENT_V2", (hook) meta2_dispatch_all,
				M2V2_FILTERS_statv2_v1},

		{"REQ_M2RAW_CONTENT_GET", (hook) meta2_dispatch_all,
				M2V2_FILTERS_raw_chunks_get_v1},
		{"REQ_M2RAW_CHUNKS_GET", (hook) meta2_dispatch_all,
				M2V2_FILTERS_raw_chunks_get_v1},
		{"REQ_M2RAW_CONTENT_GETBYPATH", (hook) meta2_dispatch_all,
				M2V2_FILTERS_raw_chunks_get_v1},
		{"REQ_M2RAW_CONTENT_GETALL", (hook) meta2_dispatch_all,
				M2V2_FILTERS_raw_list_v1},

		{"REQ_M2RAW_CONTENT_DEL", (hook) meta2_dispatch_all,
				M2V2_FILTERS_del_raw_v1},
		{"REQ_M2RAW_CHUNKS_DEL", (hook) meta2_dispatch_all,
				M2V2_FILTERS_del_raw_v1},

		// Necessary to the rawx-mover
		{"REQ_M2RAW_CONTENT_SET", (hook) meta2_dispatch_all,
				M2V2_FILTERS_set_raw_v1},
		{"REQ_M2RAW_CHUNKS_SET", (hook) meta2_dispatch_all,
				M2V2_FILTERS_set_raw_v1},

		/* CONTENT_PROPERTIES */
		{"META2_SERVICES_SET_CONTENT_PROPERTY", (hook) meta2_dispatch_all,
				M2V2_FILTERS_set_content_prop_v1},
		{"META2_SERVICES_GET_CONTENT_PROPERTY", (hook) meta2_dispatch_all,
				M2V2_FILTERS_get_content_prop_v1},
		{"META2_SERVICES_LIST_ALL_CONTENT_PROPERTIES",
				(hook) meta2_dispatch_all,
				M2V2_FILTERS_list_all_content_properties},
		{"META2_SERVICES_REMOVE_CONTENT_PROPERTY", (hook) meta2_dispatch_all,
				M2V2_FILTERS_remove_content_prop_v1},

		/* CONTENT METADATA */
		{"META2_SERVICES_MODIFY_METADATAUSR", (hook) meta2_dispatch_all,
				M2V2_FILTERS_modify_mdusr_v1},
		{"META2_SERVICES_MODIFY_METADATASYS", (hook) meta2_dispatch_all,
				M2V2_FILTERS_modify_mdsys_v1},

		/* AGENT EVENTS */
		{"REQ_M2RAW_TOUCH_CONTAINER", (hook) meta2_dispatch_all,
				M2V2_FILTERS_touch_container_v1},
		{"REQ_M2RAW_TOUCH_CONTENT", (hook) meta2_dispatch_all,
				M2V2_FILTERS_touch_content_v1},

		/* CONTAINER FLAGS */
		{"REQ_M2_GETFLAG", (hook) meta2_dispatch_all, M2V2_FILTERS_getflags},
		{"REQ_M2_SETFLAG", (hook) meta2_dispatch_all, M2V2_FILTERS_setflags},
		{"META2_SERVICES_CONTAINER_ENABLE", (hook) meta2_dispatch_all,
				M2V2_FILTERS_enable},
		{"META2_SERVICES_CONTAINER_DISABLE", (hook) meta2_dispatch_all,
				M2V2_FILTERS_disable},
		{"META2_SERVICES_CONTAINER_FREEZE", (hook) meta2_dispatch_all,
				M2V2_FILTERS_freeze},
		{"META2_SERVICES_CONTAINER_DISABLE_DISABLED", (hook) meta2_dispatch_all,
				M2V2_FILTERS_disable_frozen},

		/* RESTORE */
		{"META2_SERVICES_REPLICATE_CONTENT_V2", (hook) meta2_dispatch_all,
				M2V2_FILTERS_replicatev2_v1},

		{"REQ_M2RAW_RESTORE_CONTAINER", (hook) meta2_dispatch_all,
				M2V2_FILTERS_restore_container},

		/* CONTENT SERVICES */
		{"META2_SERVICES_SERVICE_ADD_CONTENTS", (hook) meta2_dispatch_all,
				M2V2_FILTERS_add_service_content},
		{"META2_SERVICES_SERVICE_ADD_SPARES", (hook) meta2_dispatch_all,
				M2V2_FILTERS_spare_service_content},
		{"META2_SERVICES_SERVICE_COMMIT_CONTENTS", (hook) meta2_dispatch_all,
				M2V2_FILTERS_commit_service_content},
		{"META2_SERVICES_SERVICE_ROLLBACK_CONTENTS", (hook) meta2_dispatch_all,
				M2V2_FILTERS_rollback_service_content},

		{"META2_SERVICES_SERVICE_GET_CONTENT_SERVICE",
				(hook) meta2_dispatch_all, M2V2_FILTERS_list_content_services},
		{"META2_SERVICES_SERVICE_GET_ALL_USED", (hook) meta2_dispatch_all,
				M2V2_FILTERS_list_all_content_services},

		{"META2_SERVICES_SERVICE_DELETE_CONTENTS", (hook) meta2_dispatch_all,
				M2V2_FILTERS_delete_content_services},
		{"META2_SERVICES_SERVICE_FLUSH", (hook) meta2_dispatch_all,
				M2V2_FILTERS_flush_content_services},


		/* Given up */
		{"REQ_M2RAW_CONTENT_GETBYCHUNK", (hook) meta2_dispatch_all, NULL},
		{"META2_SERVICES_CONTAINER_SERVICES_GET_ALL_USED",
				(hook) meta2_dispatch_all, NULL},
		{"META2_SERVICES_CONTAINER_SERVICES_GET_AVAILABLE",
				(hook) meta2_dispatch_all, NULL},
		...
		{"META2_SERVICES_REPLICATE_ADD_CONTAINER_EVENT",
				(hook) meta2_dispatch_all, NULL},
		{"META2_SERVICES_GET_CONTAINER_EVENT_ROWID", (hook) meta2_dispatch_all,
				NULL},
		{"META2_SERVICES_GET_CONTAINER_EVENTS_BY_TIMESTAMP",
				(hook) meta2_dispatch_all, NULL},
		{"META2_SERVICES_LIST_CONTAINER_EVENTS", (hook) meta2_dispatch_all,
				NULL},
		{"META2_SERVICES_LIST_CONTAINER_EVENTS_SINCE",
				(hook) meta2_dispatch_all, NULL},
		{"META2_SERVICES_LIST_CONTAINER_EVENTS_UP_TO",
				(hook) meta2_dispatch_all, NULL},
		{"META2_SERVICES_LIST_LAST_CONTAINER_EVENTS", (hook) meta2_dispatch_all,
				NULL},
		{"META2_SERVICES_LIST_ALL_CONTAINER_EVENTS", (hook) meta2_dispatch_all,
				NULL},
		{"META2_SERVICES_REMOVE_CONTAINER_EVENT_BY_ROWID",
				(hook) meta2_dispatch_all, NULL},
		{"META2_SERVICES_REMOVE_CONTAINER_EVENT_BY_EVENT",
				(hook) meta2_dispatch_all, NULL},
