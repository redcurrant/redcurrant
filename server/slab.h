 ...
 * @return
 */
struct data_slab_s *data_slab_sequence_shift(struct data_slab_sequence_s *dss);
 ...
 * @return
 */
struct data_slab_s *data_slab_make_path(const gchar * path,
	gboolean must_unlink);
 ...
 * @return
 */
struct data_slab_s *data_slab_make_buffer2(guint8 * buff, gboolean tobefreed,
	gsize start, gsize end, gsize alloc);
...
data_slab_make_gstr(GString * gstr)
{
	...
	return data_slab_make_buffer2((guint8 *) g_string_free(gstr, FALSE), TRUE,
		0, l, l);
}
