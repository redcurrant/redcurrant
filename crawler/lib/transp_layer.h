 ...
 * \return the errors if error occurs, else =NULL
 */
GError *crawler_bus_Register(TCrawlerBus * handle, char *service_name,
 ...
 * \return the errors if error occurs, else =NULL
*/
GError *crawler_bus_reqBase_IsNameExists(TCrawlerReq * req, const char *name,
	gboolean * name_exist);
...
GError *crawler_bus_reqCall_Send_s_as(TCrawlerReq * req, char *method_call,
	int timeout, void (*_notify_callback) (TCrawlerReq * req, GError * error,
		char **msgReceived, void *user_data), void *user_data,
	char *dataToSend);

GError *crawler_bus_reqcCall_Send_ss_s(TCrawlerReq * req, char *method_call,
	int timeout, void (*_notify_callback) (TCrawlerReq * req, GError * error,
		char *msgReceived, void *user_data), void *user_data, char *dataToSend1,
	char *dataToSend2);

GError *crawler_bus_reqcCall_Send_sss_s(TCrawlerReq * req, char *method_call,
	int timeout, void (*_notify_callback) (TCrawlerReq * req, GError * error,
		char *msgReceived, void *user_data), void *user_data, char *dataToSend1,
	char *dataToSend2, char *dataToSend3);

GError *crawler_bus_reqcCall_Send_ts_s(TCrawlerReq * req, char *method_call,
	int timeout, void (*_notify_callback) (TCrawlerReq * req, GError * error,
		char *msgReceived, void *user_data), void *user_data,
	guint64 dataToSend1, char *dataToSend2);

GError *crawler_bus_reqcCall_Send_s_as(TCrawlerReq * req, char *method_call,
	int timeout, void (*_notify_callback) (TCrawlerReq * req, GError * error,
		char **msgReceived, void *user_data), void *user_data,
	char *dataToSend);
...
GError *crawler_bus_reqSig_OpenInputQueue(TCrawlerReq * req,
	const char *signal_name, void *user_data);
GError *crawler_bus_reqSig_CloseInputQueue(TCrawlerReq * req,
