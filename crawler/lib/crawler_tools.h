 ...
 */
int disassemble_context_occur_argc_argv_uid(GVariant *, guint64 *, GVariant **,
	int *, char ***, guint64 *);

/**
 * Glue a GVariant and the command line options in a new GVariant.
 */
GVariant *assemble_context_occur_argc_argv_uid(GVariant ** b, guint64,
	GVariant *, int, char **, guint64);
...
struct trip_lib_entry_points *load_trip_library(char *path,
	char *trip_library_name);
