...
TCrawlerSvcAct *crawler_ServiceAction_GetCrtService(TCrawlerSvcActList *
	list_svc);
TCrawlerSvcAct *crawler_ServiceAction_GetNextService(TCrawlerSvcActList *
	list_svc, gboolean bEnabled);

GError *crawler_ServiceAction_InitList(TCrawlerBus * handle,
...
GError *crawler_ServiceAction_UpdateList(TCrawlerBus * handle,
	TCrawlerSvcActList * list_svc, char *prefix_service_action_name,
	char *action_name);
